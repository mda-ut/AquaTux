...
void quat_camera(float roll, float pitch, float yaw)
{
   GLfloat Matrix[16];
   glQuaternion q;
   glQuaternion qHeading;
   glQuaternion qPitch;
   glQuaternion qYaw;

   // Make the Quaternions that will represent our rotations
   qPitch.CreateFromAxisAngle(1.0f, 0.0f, 0.0f, pitch);
   qHeading.CreateFromAxisAngle(0.0f, 1.0f, 0.0f, yaw);
   qYaw.CreateFromAxisAngle(0.0f, 0.0f, 1.0f, roll);

   // Combine the pitch and heading rotations and store the results in q
   q = qPitch * qHeading * qYaw;
